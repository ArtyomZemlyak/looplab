...
import { activeNodeConcepts, conceptMaterializationStatus } from "./nodeProjection.mjs";
...
export default function ConceptChipBar({ state, onHighlight }) {
	...
	if (materialization !== "complete") return /* @__PURE__ */ _jsx("div", {
		...
		children: /* @__PURE__ */ _jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ _jsx("span", {
					className: "muted",
					children: materialization === "partial" ? "Retained IDs are display-only; filters off." : "Membership unavailable; not empty."
				})
			]
		})
	});
