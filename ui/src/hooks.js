...
// Compatibility barrel: call sites that need the aggregate hooks surface keep their import, while
// App reaches the small hook directly and does not make this run-state/trace module eager.
export { useScopedResource } from './useScopedResource.js'
