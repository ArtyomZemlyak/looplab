...
export default function RunView({ runId, onBack }) {
  ...
  return (
    <div className="app">
      ...
      {panel === 'trust' && <TrustPanel state={state} runId={runId} onSelect={selectNode} onToast={showToast} onClose={() => setPanel(null)} />}
      {panel === 'queue' && <QueuePanel state={state} runId={runId} onSelect={selectNode} onToast={showToast} onClose={() => setPanel(null)} />}
