  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'unified_agent', label: 'Unified agent', type: 'bool',
        help: 'One self-driving agent plays Researcher + Developer (+ Strategist) across stages. The per-role model fields below act as per-stage overrides (Researcher→propose, Developer→implement/repair). Off = today’s split roles.' },
