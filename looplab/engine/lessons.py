...
class LessonMemory:
    ...
    def write_reflection_note(self, final: RunState) -> None:
        ...
        if reasons:
            ...
            # §role-split: deliberately UNTAGGED (shared) — "this crash class keeps biting" is relevant
            # to BOTH the Researcher (steer away from it) and the Developer (guard the code against it).
            lessons.append({
