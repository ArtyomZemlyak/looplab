...
LAZY_ENGINE_ATTRIBUTES: dict[str, tuple[str, ...]] = {
    ...
    '_pending_batch_dropped': ('card_reservation.py::_stage_card_creates', 'novelty.py::_propose_batch', 'orchestrator.py::_handle_create_actions', 'orchestrator.py::_steady_state_build_lane'),
