...
SETTINGS_UI_SCHEMA_CATALOGUE_FIELD_COUNT = 167
...
# 167 rows since METRIC SALVAGE joined the Resilience group — `metric_salvage` (off|audit|select,
# default audit) and `metric_salvage_repair`. They belong beside the inline-repair rows because they
# answer the same question from the other end: inline repair asks "can this node be made to work",
# salvage asks "did it already, and did we throw the answer away". Reviewed together with the widened
# `inline_repair_reasons` default in the same change, whose help text now also names the two
# declared-contract reasons.
SETTINGS_UI_SCHEMA_KEYSET_REVISION = "35073de028d731d42d07513e914705cade546e4ff6805a32fcd5bfbf7c45a989"
