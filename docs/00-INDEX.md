...
> **Note:** docs 01–05 are the original *design* documents; the implementation has long since shipped (see [06-implementation-plan.md](06-implementation-plan.md) for the status board and [07-architecture-review.md](07-architecture-review.md) for the design↔code audit). Where a design doc and the code disagree, the code + `docs/guide/` are authoritative.
