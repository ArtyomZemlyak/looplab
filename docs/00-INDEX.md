...
| 31 | **[31-path-isolation-options-2026-08-13.md](31-path-isolation-options-2026-08-13.md)** | Option analysis (2026-08-13): how a node's eval is kept from reading — and scoring — a file outside its own workdir. The shipped answer is `runtime/read_fence.py`. |
| 32 | **[32-f1e-operator-declaration-options-2026-08-13.md](32-f1e-operator-declaration-options-2026-08-13.md)** | Option analysis (2026-08-13): F1e, proving a repair actually reached the declaration that failed rather than merely re-running until the contract passed. |
| 33 | **[33-cross-turn-dispatch-options-2026-08-13.md](33-cross-turn-dispatch-options-2026-08-13.md)** | Option analysis (2026-08-13): the cross-turn dispatcher and the `yield_outer` latch in `engine/speculation.py`. |
