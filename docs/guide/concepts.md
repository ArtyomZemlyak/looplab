...
| Node creation · the non-Card eval dispatch · forced steering (fork/inject/ablation/confirm) | `engine/node_build.py`, `engine/eval_dispatch.py`, `engine/forced_requests.py` |
