...
server-owned curated catalogue with **172 of the 203 direct `Settings` fields in 10 groups**. The default
**Essential** disclosure mode contains 18 high-frequency keys; search spans all 172 catalogued keys.
