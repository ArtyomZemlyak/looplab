...
server-owned curated catalogue with **167 of the 198 direct `Settings` fields in 10 groups**. The default
**Essential** disclosure mode contains 18 high-frequency keys; search spans all 167 catalogued keys.
