...
python -m pytest                  # full suite (16,479 collected, ~40 min; addopts already has -q)
...
safe to contain>`. Containment is the house posture (738 such handlers), so the rule is not "do not
