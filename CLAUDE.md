...
python -m pytest                  # full suite (16,155 collected, ~40 min; addopts already has -q)
...
safe to contain>`. Containment is the house posture (727 such handlers), so the rule is not "do not
